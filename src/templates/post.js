...
import { ClockIcon, Facebook, InstagramIcon, Linkedin, TwitterIcon } from '../components/icons';
...
const BlogPost = ({ data, children }) => {
  ...
  const imgUrl = data.mdx.frontmatter.thumbnail ? (
    data.mdx.frontmatter.thumbnail.includes('/images') ? data.mdx.frontmatter.thumbnail
...
//   // Mailchimp newsletter popup
  return (
    <Seo seoImageUrl={data.mdx.frontmatter.thumbnail} title={data.mdx.frontmatter.title}
      ...
      <script id="mcjs"
              src={'!function(c,h,i,m,p){m=c.createElement(h),p=c.getElementsByTagName(h)[0],m.async=1,m.src=i,p.parentNode.insertBefore(m,p)}(document,"script","https://chimpstatic.com/mcjs-connected/js/users/1015680a3007c259370b6f4e9/d1d99830b33d13826f947dbb1.js");'}/>
    </Seo>
  );
};
