    ...
    <div className={styles.informationContainer}>
      ...
      <p
        className={classnames(
          'text__paragraph__two__defaultGray',
          styles.textNewsletter
        )}
      >
      ...
      <div className={styles.subscribeContainer}>
        <input
          ...
          className={classnames(
            styles.inputNewsletter,
            'text__placeholder__grayThree'
          )}
        />
        <button
          className={classnames(
            styles.buttonNewsletter,
            'text__paragraph__small__neutral100'
          )}
          onClick={() => {}}
        >
          SUBSCRIBE
