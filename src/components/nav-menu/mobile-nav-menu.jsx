    ...
    <>
      <div
        className={classnames(styles.container, {
          [styles.openMenu]: showMenu,
        })}
      >
        {showTypeForm && <TypeForm onClick={() => setShowTypeForm(false)} />}
        <div
          className={classnames(styles.buttonIconPosition, {
            [styles.openButton]: showMenu,
          })}
        >
          <button
            onClick={() => setShowMenu(!showMenu)}
            className={styles.buttonIconStyles}
          >
            <MenuMobileIcon />
          </button>
        </div>
          ...
          <div>
            ...
            <div className={styles.menuContainer}>
              ...
              <div className={styles.partnerContainer}>
                <h4 className="text__label__bold__blueOne">
                  Ready to partner?
                </h4>
                <button
