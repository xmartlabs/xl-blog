    ...
    {socialAtRight && (
      <span
        className={classnames(
          'text__paragraph__bold__grayTwo',
          styles.sharePosition
        )}
      >
        Share:
      </span>
    )}
    <a href="https://twitter.com/xmartlabs">
      <TwitterIcon className={styles.socialIcon} />
    </a>
    <a
      href="https://www.facebook.com/xmartlabs/"
      className={styles.facebookSpace}
    >
      <Facebook className={styles.socialIcon} />
    </a>
    <a href="https://www.linkedin.com/company/xmartlabs/">
