...
<img src="/images/from-dashboard-to-dialogue-gif.gif" alt="User interface of a conversational analytics platform showing an agent selection panel, including an agent named 'Koda' for managing sales and inventory KPIs, with a prompt to start a session and interact through a chat-based interface." width="90%" />
