...
<p style="text-align: end;font-style: italic;">
  <img width="100%" src="/images/dogface/triplet_example.png" />
...
<p style="text-align: end;font-style: italic;">
  <img width="100%" src="/images/dogface/learning_curve.png" />
  Learning curves, loss and accuracy evolution.
</p>
...
<p style="text-align: end">
  <img width="100%" src="/images/dogface/fp_join.jpeg" />
...
<p style="text-align: end;font-style: italic;">
  <img width="100%" src="/images/dogface/fn_join.jpeg" />
...
<p style="text-align:center;">
  <img style="width: 100%" src="/images/dogface/rank_k.png" alt="rank_k" />
</p>
