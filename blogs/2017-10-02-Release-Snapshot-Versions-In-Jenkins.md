...
Today I want to show how we can release Android _SNAPSHOT_ versions using [Beta by Fabric](https://docs.fabric.io/android/beta/overview.html).
...
By doing this, you will be releasing each new feature asap with _no_ effort at all, and anyone will be able to test it to find bugs at an earlier stage, as well as making it easier to find them.
